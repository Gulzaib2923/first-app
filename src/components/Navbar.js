    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        {/* <div className="d-flex">
         ...
         <div className='bg-light rounded mx-1'onClick={()=>{props.toggleMode('light')}} style={{height:"30px",width:'30px',cursor:'pointer'}}></div>
          <div className='bg-dark rounded mx-1'onClick={()=>{props.toggleMode('dark')}} style={{height:"30px",width:'30px',cursor:'pointer'}}></div>
        </div> */}
